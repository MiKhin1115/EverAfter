  ...
  return (
    <>
      <main className="mx-auto max-w-[480px] pb-40">
        <header className="rounded-b-[32px] bg-white px-5 pb-5 pt-5 shadow-[0_12px_26px_rgba(13,92,171,0.12)]">
        ...
        <section className="grid grid-cols-1 items-start gap-6 px-5 pt-4 md:grid-cols-2 lg:grid-cols-3">
            ...
            >
              <div className="max-h-[84vh] overflow-y-auto px-5 pb-28 pt-4">
                ...
                <section className="mt-6">
                  ...
                  <div className="mt-3 grid max-h-56 grid-cols-2 gap-2 overflow-y-auto pr-1">
